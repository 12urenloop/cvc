...
instance P'.ReflectDescriptor StateGyrid where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".Gyrid.StateGyrid\", haskellPrefix = [], parentModule = [MName \"Gyrid\"], baseName = MName \"StateGyrid\"}, descFilePath = [\"Gyrid\",\"StateGyrid.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Gyrid.StateGyrid.type\", haskellPrefix' = [], parentModule' = [MName \"Gyrid\",MName \"StateGyrid\"], baseName' = FName \"type'\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 14}, typeName = Just (ProtoName {protobufName = FIName \".Gyrid.StateGyrid.Type\", haskellPrefix = [], parentModule = [MName \"Gyrid\",MName \"StateGyrid\"], baseName = MName \"Type\"}), hsRawDefault = Nothing, hsDefault = Nothing}], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False}"