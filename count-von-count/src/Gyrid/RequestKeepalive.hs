...
instance P'.ReflectDescriptor RequestKeepalive where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".Gyrid.RequestKeepalive\", haskellPrefix = [], parentModule = [MName \"Gyrid\"], baseName = MName \"RequestKeepalive\"}, descFilePath = [\"Gyrid\",\"RequestKeepalive.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Gyrid.RequestKeepalive.interval\", haskellPrefix' = [], parentModule' = [MName \"Gyrid\",MName \"RequestKeepalive\"], baseName' = FName \"interval\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 8}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 13}, typeName = Nothing, hsRawDefault = Just \"60\", hsDefault = Just (HsDef'Integer 60)},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Gyrid.RequestKeepalive.enable\", haskellPrefix' = [], parentModule' = [MName \"Gyrid\",MName \"RequestKeepalive\"], baseName' = FName \"enable\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 16}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 8}, typeName = Nothing, hsRawDefault = Just \"true\", hsDefault = Just (HsDef'Bool True)}], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False}"