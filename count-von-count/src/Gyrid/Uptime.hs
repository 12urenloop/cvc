...
instance P'.ReflectDescriptor Uptime where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".Gyrid.Uptime\", haskellPrefix = [], parentModule = [MName \"Gyrid\"], baseName = MName \"Uptime\"}, descFilePath = [\"Gyrid\",\"Uptime.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Gyrid.Uptime.gyridStartup\", haskellPrefix' = [], parentModule' = [MName \"Gyrid\",MName \"Uptime\"], baseName' = FName \"gyridStartup\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 9}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 1}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing},FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Gyrid.Uptime.systemStartup\", haskellPrefix' = [], parentModule' = [MName \"Gyrid\",MName \"Uptime\"], baseName' = FName \"systemStartup\"}, fieldNumber = FieldId {getFieldId = 2}, wireTag = WireTag {getWireTag = 17}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 1}, typeName = Nothing, hsRawDefault = Nothing, hsDefault = Nothing}], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False}"