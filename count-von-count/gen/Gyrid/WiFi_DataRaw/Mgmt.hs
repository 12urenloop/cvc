    ...
    where
        ...
        parse'beacon
         = P'.try
            (do
               v <- P'.getT "beacon"
               Prelude'.return (\ o -> o{beacon = v}))
        parse'probeReq
         = P'.try
            (do
               v <- P'.getT "probeReq"
               Prelude'.return (\ o -> o{probeReq = v}))