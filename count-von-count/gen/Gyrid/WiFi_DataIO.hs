...
instance P'.TextMsg WiFi_DataIO where
  ...
  textGet
   = do
       mods <- P'.sepEndBy (P'.choice [parse'type', parse'timestamp, parse'sensorMac, parse'hwid, parse'move]) P'.spaces
